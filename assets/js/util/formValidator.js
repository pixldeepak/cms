module.exports = {
    ...
    clearForm: function (formId) {
        $(formId).find('input[type=text],input[type=tel],input[type=email],select,textarea').val('');
        $(formId).find('input[type=checkbox],input[type=radio]').prop('checked', false)
    }
};
